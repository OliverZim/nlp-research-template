...
python train.py --val_before_training=False --training_goal=60000 -d ./data/sw --wandb_run_name="workers1" --workers=1
python train.py --val_before_training=False --training_goal=60000 -d ./data/sw --wandb_run_name="workers2" --workers=2
python train.py --val_before_training=False --training_goal=60000 -d ./data/sw --wandb_run_name="workers4" --workers=4  #default
python train.py --val_before_training=False --training_goal=60000 -d ./data/sw --wandb_run_name="workers8" --workers=8
python train.py --val_before_training=False --training_goal=60000 -d ./data/sw --wandb_run_name="workers16" --workers=16
